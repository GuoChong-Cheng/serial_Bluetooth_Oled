  ...
  <div class="flex items-center justify-center h-screen ">
    <div class="container relative flex 2xl:mx-56 aspect-video flex-nowrap" style="max-height: 90%;">
      <div class="absolute -top-8 tabs ">
        ...
        <a class="tab tab-lifted" :class="software == '串口助手' ? 'tab-active' : ''" @click="software = '串口助手'">串口助手</a>
      ...
      <div v-if="software == '串口助手'" class="flex justify-center container aspect-video flex flex-nowrap relative">
        <serial />
      </div>
