...
import SettingSerialPanel from "@/components/SettingPanel/SettingSerialPanel.vue";
...
<template>
  <!-- <div class="flex justify-center items-center h-screen"> -->
      ...
      <SettingSerialPanel class="basis-1/4 border-solid border-2 border-gray-400 rounded-xl p-5" />
      <div class="w-7"></div>
